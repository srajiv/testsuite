...
/*
 * NAME
 *	Tspi_Nv_DefineSpace05.c	
 *
 * DESCRIPTION
 *	This test will verify Tspi_NV_DefineSpace with Owner password and
 *	with NV password
 *	The permission require the NV PW(AUTHWRITE)
...
main_v1_2(char version)
{
	...
	char	     *nameOfFunction    = "Tspi_Nv_DefineSpace05";
	...
	result = Tspi_SetAttribUint32(hNVStore, TSS_TSPATTRIB_NV_INDEX, 0,0x00011105);
	if (result != TSS_SUCCESS)
	{
