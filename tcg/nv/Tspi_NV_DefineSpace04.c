...
/*
 * NAME
 *	Tspi_Nv_DefineSpace04.c
 *
 * DESCRIPTION
 *	This test will verify Tspi_NV_DefineSpace without NV(auth) password
 *	The permission requires the NV AUTHWrite PW
 *	The purpose of this test case is to get TSS_E_BAD_PARAMETER to be returned.
 ...
 *		If nvlocked, Setsecret to TPM policy with correct owner passwd
...
main_v1_2(char version)
{
	...
	result = Tspi_SetAttribUint32(hNVStore, TSS_TSPATTRIB_NV_INDEX, 0,0x00011104);
	if (result != TSS_SUCCESS)
	{
