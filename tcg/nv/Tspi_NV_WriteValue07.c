...
{
	char	     *nameOfFunction    = "Tspi_Nv_WriteValue07";
	...
	result = Tspi_SetAttribUint32(hNVStore, TSS_TSPATTRIB_NV_INDEX, 0,0x00011138);
	if (result != TSS_SUCCESS)
	{
