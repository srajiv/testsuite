...
/*
 * NAME
 *	Tspi_Nv_DefineSpace03.c
 *
 * DESCRIPTION
 *	This test will verify Tspi_NV_DefineSpace with NV(auth) password
 *	The permission not require the NV PW
...
main_v1_2(char version)
{
	...
	char	     *nameOfFunction    = "Tspi_Nv_DefineSpace03";
	...
	result = Tspi_SetAttribUint32(hNVStore, TSS_TSPATTRIB_NV_INDEX, 0,0x00011103);
	if (result != TSS_SUCCESS)
	{
