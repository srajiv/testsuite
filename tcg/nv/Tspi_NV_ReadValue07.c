...
{
	char	     *nameOfFunction    = "Tspi_Nv_ReadValue07";
	...
	result = Tspi_SetAttribUint32(hNVStore, TSS_TSPATTRIB_NV_INDEX, 0,0x00011148);
	if (result != TSS_SUCCESS)
	{
