 ...
 *		Setsecret to TPM policy with the wrong owner passwd
 *		Tspi_SetAttribUint32(Index, permission, datasize)
 *		(The Index is 0x00011117)
...
{
	char	     *nameOfFunction    = "Tspi_Nv_ReleaseSpace04";
	...
	result = Tspi_SetAttribUint32(hNVStore, TSS_TSPATTRIB_NV_INDEX, 0,0x00011117);
	if (result != TSS_SUCCESS)
	{
