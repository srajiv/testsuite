 ...
 *
 * DESCRIPTION
 *	This test will verify Tspi_NV_ReadValue with wrong password
 *	The index require the authread
...
{
	char	     *nameOfFunction    = "Tspi_Nv_ReadValue06";
	...
	result = Tspi_SetAttribUint32(hNVStore, TSS_TSPATTRIB_NV_INDEX, 0,0x00011146);
	if (result != TSS_SUCCESS)
	{
