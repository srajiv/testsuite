...
/*
 * NAME
 *	Tspi_Nv_DefineSpace07.c
 *
 * DESCRIPTION
 *	This test will verify Tspi_NV_DefineSpace with a defined index
 *	The purpose of this test case is to get TSS_E_NV_AREA_EXIST to be returned.
 ...
 *		(The Index is 0x00011107)
 *		(The Permission is 0x2000)
 *		(The datasize is 0xa)
 *		Tspi_NV_DefineSpace
 *		Tspi_NV_DefineSpace(define twice, will return error!)
 *
 *	Test:	
...
main_v1_2(char version)
{
	...
	char	     *nameOfFunction    = "Tspi_Nv_DefineSpace07";
	...
	result = Tspi_SetAttribUint32(hNVStore, TSS_TSPATTRIB_NV_INDEX, 0,0x00011107);
	if (result != TSS_SUCCESS)
	{
...
#ifdef NV_LOCKED	
       if (TSS_ERROR_CODE(result)== TSS_E_NV_AREA_EXIST)
       {              
