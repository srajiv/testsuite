...
/*
 * NAME
 *	Tspi_Nv_DefineSpace12.c
 *
 * DESCRIPTION
 *	This test will verify Tspi_NV_DefineSpace without Owner password
 *	All the input is correct, the tpm has been taken owner
 *	The purpose of this test case is to get TSS_SUCCESS or TPM_OWNER_SET to be returned.
 *	If nv locked, reutrn TPM_OWNER_SET or TPM_E_BAD_PRESENCE
 *	If unlocked, return TSS_SUCCESS
