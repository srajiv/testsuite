...
/*
 * NAME
 *	Tspi_Nv_DefineSpace09.c
 *
 * DESCRIPTION
 *	This test will verify Tspi_NV_DefineSpace with bad datasize
 *	The purpose of this test case is to get TPM_E_BAD_DATASIZE 
 *	or TPM_E_BAD_PARAM_SIZE to be returned.
...
main_v1_2(char version)
{
	...
	char         *nameOfFunction    = "Tspi_Nv_DefineSpace09";
	...
	result = Tspi_SetAttribUint32(hNVStore, TSS_TSPATTRIB_NV_DATASIZE, 0, 0);
	if (result != TSS_SUCCESS)
	{
...
#endif
#ifdef NV_LOCKED	
       if (TSS_ERROR_CODE(result)== TPM_E_BAD_DATASIZE
		||TSS_ERROR_CODE(result)==TPM_E_BAD_PARAM_SIZE)
       {              
