...
/*
 * NAME
 *	Tspi_Nv_DefineSpace06.c
 *
 * DESCRIPTION
 *	This test will verify Tspi_NV_DefineSpace with an wrong handle
 ...
 *		(The Index is 0x00011106)
 *		(The Permission is 0x2000)
 *		(The datasize is 0xa)
 *		Tspi_NV_DefineSpace(-1,..,..)  
 *
 *	Test:	
...
main_v1_2(char version)
{
	...
	char	     *nameOfFunction    = "Tspi_Nv_DefineSpace06";
