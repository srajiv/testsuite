...
/*
 * NAME
 *	Tspi_Nv_DefineSpace02.c
 *
 * DESCRIPTION
 *	This test will verify Tspi_NV_DefineSpace with Owner wrong password
 *	The purpose of this test case is to get TPM_E_AUTHFAIL to be returned.
 ...
 *		Setsecret to TPM policy with wrong owner passwd
 *		Tspi_SetAttribUint32(Index, permission, datasize)
 *		(The Index is 0x00011102)
...
main_v1_2(char version)
{
	...
	char         *nameOfFunction    = "Tspi_Nv_DefineSpace02";
	...
	result = Tspi_SetAttribUint32(hNVStore, TSS_TSPATTRIB_NV_INDEX, 0,0x00011102);
	if (result != TSS_SUCCESS)
	{
