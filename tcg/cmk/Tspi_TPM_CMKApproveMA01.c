...
/*
 * NAME
 *	Tspi_TPM_CMKApproveMA01.c
 *
 * DESCRIPTION
 *	This test will verify Tspi_TPM_CMKApproveMA.
 ...
 *
 *	Test:	Call CMKApproveMA. If it is not a success
...
static char *nameOfFunction = "Tspi_TPM_CMKApproveMA01";
