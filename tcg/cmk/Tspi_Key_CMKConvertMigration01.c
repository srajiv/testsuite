...
/*
 * NAME
 *	Tspi_Key_CMKConvertMigration01.c
 *
 * DESCRIPTION
 *	This test will verify Tspi_Key_CMKConvertMigration.
 ...
 *
 *	Test:	Call CMKConvertMigration. If it is not a success
...
static char *nameOfFunction = "Tspi_Key_CMKConvertMigration01";
