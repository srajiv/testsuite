...
/*
 * NAME
 *	Tspi_TPM_CMKCreateTicket01.c
 *
 * DESCRIPTION
 *	This test will verify Tspi_TPM_CMKCreateTicket.
 ...
 *
 *	Test:	Call CMKCreateTicket. If it is not a success
...
static char *nameOfFunction = "Tspi_TPM_CMKCreateTicket01";
