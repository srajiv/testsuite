...
/*
 * NAME
 *	Tspi_TPM_Delegate_CreateDelegation04.c
 *
 * DESCRIPTION
 *	This test will verify that Tspi_TPM_Delegate_CreateDelegation returns a bad parameter error 
 *		(in ulFlags parameter) when it should.
 *
 * ALGORITHM
 *	Setup:
 *		Create Context
...
{
	char *			function = "Tspi_TPM_Delegate_CreateDelegation04";
	...
	result = Tspi_TPM_Delegate_CreateDelegation(hTPM, 'b', -1, NULL_HPCRS, hFamily, hDelegation);
