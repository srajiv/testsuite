...
{
	char			*function = "Tspi_TPM_GetCapability14";
	...
	subCap = TSS_TPMCAP_PROP_AUTHSESSIONS;
	...
	else
	{
		...
		if (pulRespDataLength == sizeof(UINT32))
			fprintf(stderr, "\tThere are %u available authorization sessions in this TPM\n\n",
				*(UINT32 *)pRetData );
	}
