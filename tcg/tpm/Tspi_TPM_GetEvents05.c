...
main_v1_1(void){
	char		*nameOfFunction = "Tspi_TPM_GetEvents05";
	...
	result = Tspi_TPM_GetEvents(hTPM, ulPcrIndex,
			ulStartNumber,&ulEventNumber, &prgPcrEvents);
