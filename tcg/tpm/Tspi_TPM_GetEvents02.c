...
/*
 * NAME
 *	Tspi_TPM_GetEvents02.c
 *
 * DESCRIPTION
 *	This test will verify Tspi_TPM_GetEvents
 *	The purpose of this test case is to get TSS_E_BAD_PARAMTER to be 
 *		returned. This is accomplished by passing in NULL for the fifth
 *		parameter
 *
 * ALGORITHM
 *	Setup:
...
main_v1_1(void){
	char		*nameOfFunction = "Tspi_TPM_GetEvents02";
