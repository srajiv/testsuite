...
/*
 * NAME
 *	Tspi_TPM_Delegate_CreateDelegation03.c
 *
 * DESCRIPTION
 *	This test will verify that Tspi_TPM_Delegate_CreateDelegation returns an invalid handle error
...
{
	char *			function = "Tspi_TPM_Delegate_CreateDelegation03";
	...
	result = Tspi_TPM_Delegate_CreateDelegation(hTPM2, 'b', 0, NULL_HPCRS, hFamily, hDelegation);
