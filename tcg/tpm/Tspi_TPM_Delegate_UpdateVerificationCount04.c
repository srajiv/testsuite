...
/*
 * NAME
 *	Tspi_TPM_Delegate_UpdateVerificationCount04.c
 *
 * DESCRIPTION
 *	This test will verify that Tspi_TPM_Delegate_UpdateVerificationCount returns a bad parameter error
 *	when it should.
 *
 * ALGORITHM
 *	Setup:
...
{
	char *			function = "Tspi_TPM_Delegate_UpdateVerificationCount04";
	TSS_HCONTEXT		hContext;
	TSS_HKEY		hSRK;
	TSS_HTPM		hTPM;
	TSS_HPOLICY		hTPMPolicy;
	TSS_HHASH 		hHash = NULL_HHASH; /* tests BAD_PARAMETER error code */
	...
	result = Tspi_TPM_Delegate_UpdateVerificationCount(hTPM, hHash);
