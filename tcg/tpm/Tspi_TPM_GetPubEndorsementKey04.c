...
/*
 * NAME
 *	Tspi_TPM_GetPubEndorsementKey04.c
 *
 * DESCRIPTION
 ...
 *		an invalid second parameter. In this test case -1 is 
...
main_v1_1(void){
	...
	char		*nameOfFunction = "Tspi_TPM_GetPubEndorsementKey04";
	TSS_RESULT	result;
	...
	result = Tspi_TPM_GetPubEndorsementKey(hTPM, -1, NULL, NULL);
