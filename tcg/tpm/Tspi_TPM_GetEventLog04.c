...
/*
 * NAME
 *	Tspi_TPM_GetEventLog04.c
 *
 * DESCRIPTION
 *	This test will verify Tspi_TPM_GetEventLog
 *	The purpose of this test case is get TSS_E_BAD_PARAMETER to 
 *		be returned. This is accomplished by only calling 
 *		GetEventLog without initializing or setting anything up.
 *
 * ALGORITHM
 *	Setup:	None
 *
...
main_v1_1(void){
	char		*nameOfFunction = "Tspi_TPM_GetEventLog04";
