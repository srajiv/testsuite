...
/*
 * NAME
 *	Tspi_TPM_GetCapability11.c
 *
 * DESCRIPTION
 *	This test will verify that Tspi_TPM_GetCapability gets the maximum number
 *		of rows in the delegate table.
 *
 * ALGORITHM
 *	Setup:
 *		Create Context
...
{
	char			*function = "Tspi_TPM_GetCapability11";
	...
	subCap = TSS_TPMCAP_PROP_DELEGATEROWS;
	...
	else
	{
		...
		if (pulRespDataLength == sizeof(UINT32))
			fprintf(stderr, "\tThe maximum number of rows in the delegate table is %u \n\n",
				*(UINT32 *)pRetData );
	}
