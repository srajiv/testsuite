...
/*
 * NAME
 *	Tspi_TPM_PcrExtend04.c
 *
 * DESCRIPTION
 *	This test will verify Tspi_TPM_PcrExtend
 *	The purpose of this test case is to get TSS_E_BAD_PARAMETER
 *		to be returned. To accomplish this, NULL is passed
 *		in as the fifth parameter, and 4 is passed in as
 *		the third parameter.
 *
 * ALGORITHM
 *	Setup:
...
main_v1_1(void){
	...
	char		*nameOfFunction = "Tspi_TPM_PcrExtend04";
	...
	if (result != TSS_SUCCESS) {
		...
		//Call PcrExtend
	result = Tspi_TPM_PcrExtend(hTPM, 9, 4,
