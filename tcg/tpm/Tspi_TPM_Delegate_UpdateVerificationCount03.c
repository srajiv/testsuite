...
/*
 * NAME
 *	Tspi_TPM_Delegate_UpdateVerificationCount03.c
 *
 * DESCRIPTION
 *	This test will verify that Tspi_TPM_Delegate_UpdateVerificationCount returns an invalid handle error
 *	when it should.
 *
 * ALGORITHM
 *	Setup:
 ...
 *		Connect Context
 *		Get TPM Handle
 *		Call Verification Count function with invalid handle
 *
 *	Test:
