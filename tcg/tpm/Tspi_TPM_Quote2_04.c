 ...
 *		Set Secret for key
 *		Create hIdentKey
 *		SelectPcrIndexEx NOT CALLED (invalid structure)
 *		Get Random
 *		Set Validation Data
 *
...
int main_v1_2(char version){
	...
	char		*nameOfFunction = "Tspi_TPM_Quote2_04";
	...
	result = Tspi_TPM_Quote2(hTPM, hIdentKey, TRUE,
				-1, &pValidationData,&versionInfoSize,&versionInfo);
