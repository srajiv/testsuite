...
main_v1_1( void )
{
	char			*function = "Tspi_TPM_GetCapability15";
	...
	subCap = TSS_TPMCAP_PROP_MAXAUTHSESSIONS;
	...
	else
	{
		...
		if (pulRespDataLength == sizeof(UINT32))
			fprintf(stderr, "\tMaximum number of loaded authorization sessions "
					"supported by TPM: %u \n\n", *(UINT32 *)pRetData );
	}
