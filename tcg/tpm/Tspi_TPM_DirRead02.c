...
main_v1_1(void){
	...
	char		*nameOfFunction = "Tspi_TPM_DirRead02";
	...
	if (result != TSS_SUCCESS) {
		...
		//Dir Read
	result = Tspi_TPM_DirRead(-1, dirIndex, &pulDirDataLength, &pdirValue);
