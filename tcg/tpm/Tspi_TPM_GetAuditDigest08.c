...
/*
 * NAME
 *	Tspi_TPM_GetAuditDigest08.c
 *
 * DESCRIPTION
 *	This test will verify that Tspi_TPM_GetAuditDigest
 *		returns TSS_E_BAD_PARAMETER error code if validation data is invalid.
 *
 * ALGORITHM
 *	Setup:
 *		Create Context
...
{
	char *			function = "Tspi_TPM_GetAuditDigest08";
	...
	memset(&valData, 0, sizeof(TSS_VALIDATION));
