...
/*
 * NAME
 *	Tspi_TPM_CreateMaintenanceArchive02.c
 *
 * DESCRIPTION
 *	This test will return TSS_E_INVALID_HANDLE, because
 *		whTPM=-1 is passed in as the first parameter
 *		to TPM_CreateMaintenanceArchive, rather than
 *		hTPM.
 *
 * ALGORITHM
 *	Setup:
...
main_v1_1( void )
{
	char		*function = "Tspi_TPM_CreateMaintenanceArchive02";
