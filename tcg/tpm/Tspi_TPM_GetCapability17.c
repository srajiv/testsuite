...
{
	char			*function = "Tspi_TPM_GetCapability17";
	...
	subCap = TSS_TPMCAP_PROP_MAXTRANSESSIONS;
	...
	else
	{
		...
		if (pulRespDataLength == sizeof(UINT32))
			fprintf(stderr, "\tMaximum number of loaded transport sessions in this TPM: %u\n\n", *(UINT32 *)pRetData );
	}
