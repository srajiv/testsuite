...
main_v1_1(void){
	...
	char		*nameOfFunction	= "Tspi_TPM_GetEvent04";
	...
	if (result != TSS_SUCCESS) {
		...
		//Get Event
	result = Tspi_TPM_GetEvent(hTPM, -1, 
			ulEventNumber, NULL);
