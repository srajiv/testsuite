...
/*
 * NAME
 *	Tspi_TPM_Delegate_CreateDelegation07.c
 *
 * DESCRIPTION
...
{
	char *			function = "Tspi_TPM_Delegate_CreateDelegation07";
	...
	result = Tspi_TPM_Delegate_CreateDelegation(hTPM, 'b', 0, NULL_HPCRS, hFamily, 0xffffffff);
