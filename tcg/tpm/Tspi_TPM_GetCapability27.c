...
main_v1_1( void )
{
	char			*function = "Tspi_TPM_GetCapability27";
	...
	subCap = TSS_TPMCAP_PROP_ACTIVECOUNTER;
	...
	else
	{
		...
		if (pulRespDataLength == sizeof(UINT32))
			fprintf(stderr, "\tID of the current counter: %x \n\n", *(UINT32 *)pRetData );
	}
