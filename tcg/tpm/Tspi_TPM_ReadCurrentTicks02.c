...
/*
 * NAME
 *	Tspi_TPM_ReadCurrentTicks02.c
 *
 * DESCRIPTION
 *	This test will verify that Tspi_TPM_ReadCurrentTicks returns TSS_E_BAD_PARAMTER when
 *	passed a NULL TPM_CURRENT_TICKS struct.
 *
 * ALGORITHM
 *	Setup:
 *		Create Context
...
{
	char		  *nameOfFunction = "Tspi_TPM_ReadCurrentTicks02";
	...
	result = Tspi_TPM_ReadCurrentTicks(hTPM, NULL);
