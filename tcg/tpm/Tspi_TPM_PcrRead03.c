...
/*
 * NAME
 *	Tspi_TPM_PcrRead03.c
 *
 * DESCRIPTION
 *	This test will return TSS_E_BAD_PARAMETER, because
 *		-1 is passed as the second parameter to
 *		TPM_PcrRead03, rather than 8.
 *
 * ALGORITHM
 *	Setup:
 *		Create Context
...
main_v1_1( void )
{
	char			*function = "Tspi_TPM_PcrRead03";
	BYTE			*rgbPcrValue;
	...
	result = Tspi_TPM_PcrRead( hTPM, -1, &ulPcrValueLength, &rgbPcrValue );
