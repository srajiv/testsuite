...
/*
 * NAME
 *	Tspi_TPM_Delegate_CacheOwnerDelegation05.c
 *
 * DESCRIPTION
 *	This test will verify that Tspi_TPM_Delegate_CacheOwnerDelegation returns an invalid handle error
...
{
	char *			function = "Tspi_TPM_Delegate_CacheOwnerDelegation05";
