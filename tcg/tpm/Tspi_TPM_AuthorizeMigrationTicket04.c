...
main_v1_1(void){
	...
	char		*nameOfFunction = "Tspi_TPM_AuthorizeMigrationTicket04";
	...
	result = Tspi_TPM_AuthorizeMigrationTicket(hTPM, 
			hTargetPubKey, TSS_MS_REWRAP, NULL, &MigTicket); 
