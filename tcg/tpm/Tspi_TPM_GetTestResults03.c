...
/*
 * NAME
 *	Tspi_TPM_GetTestResults03.c
 *
 * DESCRIPTION
 *	This test will verify Tspi_TPM_GetTestResults.
 *	The purpose of this test is to get TSS_E_INVALID_HANLDE to 
 *		be returned. This is easily accomplished by passing in 
...
main_v1_1(void){
	...
	char		*nameOfFunction = "Tspi_TPM_GetTestResults03";
	...
	if (result != TSS_SUCCESS) {
		...
		//Get Test Result
	result = Tspi_TPM_GetTestResult(-1, &TestResultLength, &prgbTestResult);
