...
main_v1_1( void )
{
	char			*function = "Tspi_TPM_GetCapability19";
	...
	subCap = TSS_TPMCAP_PROP_MAXSESSIONS;
	...
	else
	{
		...
		if (pulRespDataLength == sizeof(UINT32))
			fprintf(stderr, "\tThe maximum number of sessions supported by the TPM is %u\n\n",
				*(UINT32 *)pRetData );
	}
