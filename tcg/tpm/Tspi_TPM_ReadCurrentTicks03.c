...
/*
 * NAME
 *	Tspi_TPM_ReadCurrentTicks03.c
 *
 * DESCRIPTION
 *	This test will verify that Tspi_TPM_ReadCurrentTicks returns TSS_E_INVALID_HANDLE when
 *	passed an invalid TPM handle.
 *
 * ALGORITHM
 *	Setup:
 *		Create Context
...
{
	char		  *nameOfFunction = "Tspi_TPM_ReadCurrentTicks03";
	...
	result = Tspi_TPM_ReadCurrentTicks(0xffffffff, &ticks);
