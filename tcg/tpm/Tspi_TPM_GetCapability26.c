...
{
	char			*function = "Tspi_TPM_GetCapability26";
	...
	subCap = TSS_TPMCAP_PROP_MAXCOUNTERS;
	...
	else
	{
		...
		if (pulRespDataLength == sizeof(UINT32))
			fprintf(stderr, "\tThe maximum number of monotonic counters is %u \n\n",
				*(UINT32 *)pRetData );
	}
