...
{
	char			*function = "Tspi_TPM_GetCapability25";
	...
	subCap = TSS_TPMCAP_PROP_COUNTERS;
	...
	else
	{
		...
		if (pulRespDataLength == sizeof(UINT32))
			fprintf(stderr, "\tThere are %u available monotonic counters in this TPM\n\n",
				*(UINT32 *)pRetData );
	}
