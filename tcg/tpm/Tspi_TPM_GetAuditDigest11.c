...
/*
 * NAME
 *	Tspi_TPM_GetAuditDigest11.c
 *
 * DESCRIPTION
 *	This test will verify that Tspi_TPM_GetAuditDigest returns TSS_E_BAD_PARAMETER
 *				error code if the list of audited ordinals is NULL.
 *
 * ALGORITHM
 *	Setup:
 *		Create Context
...
{
	char *			function = "Tspi_TPM_GetAuditDigest11";
	...
	result = Tspi_TPM_GetAuditDigest(hTPM, NULL_HKEY, FALSE, &auditDigestLen, &auditDigest,
					 &counterValue, NULL, &ordListLen, NULL);
