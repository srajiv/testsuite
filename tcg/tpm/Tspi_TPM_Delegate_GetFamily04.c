...
/*
 * NAME
 *	Tspi_TPM_Delegate_GetFamily04.c
 *
 * DESCRIPTION
 *	This test will verify that Tspi_TPM_Delegate_GetFamily returns an bad parameter error
 *	when it should.
 *
 * ALGORITHM
 *	Setup:
...
{
	char *			function = "Tspi_TPM_Delegate_GetFamily04";
	...
	result = Tspi_TPM_Delegate_GetFamily(hTPM, familyID, NULL);
