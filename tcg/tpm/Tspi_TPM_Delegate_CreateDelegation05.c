...
/*
 * NAME
 *	Tspi_TPM_Delegate_CreateDelegation05.c
 *
 * DESCRIPTION
...
{
	char *			function = "Tspi_TPM_Delegate_CreateDelegation05";
	...
	result = Tspi_TPM_Delegate_CreateDelegation(hTPM, 'b', 0, 0xffffffff, hFamily, hDelegation);
