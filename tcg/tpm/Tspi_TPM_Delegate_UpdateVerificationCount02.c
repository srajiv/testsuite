...
/*
 * NAME
 *	Tspi_TPM_Delegate_UpdateVerificationCount02.c
 *
 * DESCRIPTION
 *	This test will verify that Tspi_TPM_Delegate_UpdateVerificationCountan returns an invalid handle error
 *	when it should.
 *
 * ALGORITHM
 *	Setup:
...
{
	char *			function = "Tspi_TPM_Delegate_UpdateVerificationCount02";
