...
/*
 * NAME
 *	Tspi_TPM_GetAuditDigest03.c
 *
 * DESCRIPTION
 *	This test will verify that Tspi_TPM_GetAuditDigest
 *		returns TSS_E_INVALID_HANDLE error code for hTPM handle.
 *
 * ALGORITHM
 *	Setup:
 *		Create Context
...
{
	char *			function = "Tspi_TPM_GetAuditDigest03";
	...
	if (result != TSS_SUCCESS) {
		...
		// Call GetAuditDigest
	result = Tspi_TPM_GetAuditDigest(0xffffffff, NULL_HKEY, FALSE, &auditDigestLen, &auditDigest,
