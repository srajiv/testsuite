...
/*
 * NAME
 *	Tspi_TPM_CreateEndorsementKey02.c
 *
 * DESCRIPTION
 *	This test will return TSS_E_INVALID_HANDLE, because whTPM=-1
 *		is passed as the first parameter to
 *		TPM_CreateEndorsementKey, instead of hTPM.
 *
 * ALGORITHM
 *	Setup:
 *		Create Context
...
main_v1_1( void )
{
	char			*function = "Tspi_TPM_CreateEndorsementKey02";
	...
	result = Tspi_TPM_CreateEndorsementKey( whTPM, hKey, NULL );
