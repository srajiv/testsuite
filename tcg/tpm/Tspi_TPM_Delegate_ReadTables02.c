...
/*
 * NAME
 *	Tspi_TPM_Delegate_ReadTables02.c
 *
 * DESCRIPTION
 *	This test will verify that Tspi_TPM_Delegate_ReadTables returns an invalid handle error
 *	when it should.
 *
 * ALGORITHM
 *	Setup:
...
{
	char *			function = "Tspi_TPM_Delegate_ReadTables02";
	...
	result = Tspi_TPM_Delegate_ReadTables(0xffffffff, &familyTableSize, &familyTable,
