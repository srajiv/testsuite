...
/*
 * NAME
 *	Tspi_TPM_Delegate_VerifyDelegation02.c
 *
 * DESCRIPTION
 *	This test will verify that Tspi_TPM_Delegate_VerifyDelegation an invalid handle error
 *	when it should.
 *
 * ALGORITHM
 *	Setup:
...
{
	char *			function = "Tspi_TPM_Delegate_VerifyDelegation02";
