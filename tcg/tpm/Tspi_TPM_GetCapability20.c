...
{
	char			*function = "Tspi_TPM_GetCapability20";
	...
	subCap = TSS_TPMCAP_PROP_CONTEXTS;
	...
	else
	{
		...
		if (pulRespDataLength == sizeof(UINT32))
			fprintf(stderr, "\tThe number of available saved session slots is %u \n\n",
				*(UINT32 *)pRetData );
	}
