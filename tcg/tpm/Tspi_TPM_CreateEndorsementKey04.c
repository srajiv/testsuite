...
/*
 * NAME
 *	Tspi_TPM_CreateEndorsementKey04.c
 *
 * DESCRIPTION
 *	This test will return TSS_E_NOTIMPL, because internal
 *		functions which are called by TPM_CreateEndorsementKey
 *		are not implemented.
 *
 * ALGORITHM
 *	Setup:
...
main_v1_1( void )
{
	char			*function = "Tspi_TPM_CreateEndorsementKey04";
