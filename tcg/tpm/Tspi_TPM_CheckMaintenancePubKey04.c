...
/*
 * NAME
 *	Tspi_TPM_CheckMaintenancePubKey04.c
 *
 * DESCRIPTION
 *	This test will return TSS_E_NOTIMPL because
 *		Tspi_TPM_CheckMaintenancePubKey is
...
main_v1_1( void )
{
	char		*function = "Tspi_TPM_CheckMaintenancePubKey04";
