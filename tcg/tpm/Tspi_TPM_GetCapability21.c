...
main_v1_1( void )
{
	char			*function = "Tspi_TPM_GetCapability21";
	...
	subCap = TSS_TPMCAP_PROP_MAXCONTEXTS;
	...
	else
	{
		...
		if (pulRespDataLength == sizeof(UINT32))
			fprintf(stderr, "\tThe maximum number of saved session slots is %u \n\n",
				*(UINT32 *)pRetData );
	}
