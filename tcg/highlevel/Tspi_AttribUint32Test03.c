...
main_v1_1( void )
{
	char			*function = "Tspi_AttribUint32Test03";
...
/* ###################### Key 0 ####################### */
	...
	fprintf( stderr, "\t\tAuthDataUsage: %x\n", ES );
...
/* #################### Key 3 ###################### */
	...
	{
		/* if it does not require authorization - default */
		if( ES == 0 )
		{
			print_success( function1, result);
			exitCode = 0;
