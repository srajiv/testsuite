 ...
 *              Load Key
 *              Create PCRS Object
 *		PcrComposite SelectPcrIndex
 *		PcrComposite SelectPcrValue
...
main_v1_1(void){
	...
	char		*nameOfFunction = "Tspi_Data_Seal03";
	TSS_FLAGS	initFlags;
	TSS_HKEY	hKey;
	TSS_HKEY	hSRK;
	...
	print_success("Create PCR Object", result);
	...
	print_success("PCR SetPcrValue", result);
