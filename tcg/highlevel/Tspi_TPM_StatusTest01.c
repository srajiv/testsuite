...
/*
 * NAME
 *	Tspi_TPM_StatusTest01.c
 *
 * DESCRIPTION
 *	This test will use Tspi_TPM_GetStatus to show that
 ...
 *		Set Secret
 *	Test:
 *		Call Tspi_TPM_GetStatus and check default values
...
main_v1_1( void )
{
	char			*function = "Tspi_TPM_StatusTest01";
	char			*function1 = "Tspi_TPM_GetStatus";
	TSS_HKEY		hParentKey;
	TSS_HTPM		hTPM;
	TSS_RESULT		result;
	TSS_HPOLICY		hPolicy;
...
/* ###################### Get Status ####################### */
	...
	fprintf( stderr, "\t\tPhysical Set Disabled: %x\n", state );
	...
	fprintf( stderr, "\t\tAllow Maintenance: %x\n", state );
	...
	fprintf( stderr, "\t\tPhysical Presence Lifetime Lock: %x\n", state );
	...
	fprintf( stderr, "\t\tPhysical Presence Hardware Enable: %x\n", state );
	...
	fprintf( stderr, "\t\tPhysical Presence Command Enable: %x\n", state );
	...
	fprintf( stderr, "\t\tEndorsement Key Pair W/ Function: %x\n", state );
	...
	fprintf( stderr, "\t\tUser Physically Present: %x\n", state );
	...
	fprintf( stderr, "\t\tPhysical Presence Lock: %x\n", state );
