 ...
 *		parameters to Data_Seal, rather than hEncData
...
main_v1_1( void )
{
	char		*function = "Tspi_Data_Seal02";
	TSS_HCONTEXT	hContext;
	TSS_HCONTEXT	whContext;
	TSS_HKEY	hSRK;
	TSS_HKEY	hKey;
	...
	if ( result != TSS_SUCCESS )
	{
		...
		// Data Seal
	result = Tspi_Data_Seal( whContext, whContext, ulDataLength,
