...
#define TESTSUITE_DELEGATE_SECRET	getenv("TESTSUITE_DELEGATE_SECRET")
#define TESTSUITE_DELEGATE_SECRET_LEN	TESTSUITE_DELEGATE_SECRET == NULL ? 0 : strlen(TESTSUITE_DELEGATE_SECRET)
