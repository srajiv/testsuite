...
/*
 * NAME
 *	Tspi_Hash_UpdateHashValue01.c
 *
 * DESCRIPTION
 *	This test will verify that Tspi_Hash_UpdateHashValue
 *		returns TSS_SUCCESS.
 *
 * ALGORITHM
 *	Setup:
...
int main_v1_1(void)
{
	char *function = "Tspi_Hash_UpdateHashValue01";
	...
	result = Tspi_Hash_UpdateHashValue(hHash, 24,
