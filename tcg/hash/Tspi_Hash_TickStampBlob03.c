...
/*
 * NAME
 *	Tspi_Hash_TickStampBlob03.c
 *
 * DESCRIPTION
 *	This test will verify that Tspi_Hash_TickStampBlob returns TSS_E_INVALID_HANDLE when the
 *	key object's handle is incorrect.
 *
 * ALGORITHM
 *	Setup:
 *		Create Context
...
{
	char *function = "Tspi_Hash_TickStampBlob03";
	...
	result = Tspi_Hash_TickStampBlob(hHash, 0xffffffff, &validationData);
