...
/*
 * NAME
 *	Tspi_Context_LoadKeyByBlob02.c
 *
 * DESCRIPTION
 *	This test will return TSS_E_INVALID_HANDLE, because
 *		whSRK (-1) is passed in as the second parameter of
 *		Context_LoadKeyByBlob.
 *
 * ALGORITHM
 *	Setup:
 *              Create Context
...
main_v1_1( void )
{
	char		*function = "Tspi_Context_LoadKeyByBlob02";
	...
	if ( result != TSS_SUCCESS )
	{
		...
		//Load Key Blob, deliberate fail to return invalid handle
	result = Tspi_Context_LoadKeyByBlob( hContext, whSRK,
						blobLength,
