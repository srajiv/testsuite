...
/*
 * NAME
 *	Tspi_Context_Connect02.c
 *
 * DESCRIPTION
 *	This test will verify Tspi_Context_Connect.
 *	The purpose of this test case is to get TSS_E_INVALID_HANDLE to 
 *		be returned. This is done by passing in -1 for the handle.
 *
 * ALGORITHM
 *	Setup:
 *		Create Context
 *
 *	Test:	Call Connect Context then if it is not a success
...
main_v1_1(void){
	...
	char		*nameOfFunction = "Tspi_Context_Connect02";
	...
	if (result != TSS_SUCCESS) {
		...
		//Connect Context
	result = Tspi_Context_Connect(-1, get_server(GLOBALSERVER));
