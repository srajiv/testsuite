...
/*
 * NAME
 *	Tspi_Context_SetTransEncryptionKey02.c
 *
 * DESCRIPTION
...
{
	char		*nameOfFunction = "Tspi_Context_SetTransEncryptionKey02";
	...
	result = Tspi_Context_SetTransEncryptionKey(hContext, 0xffffffff);
