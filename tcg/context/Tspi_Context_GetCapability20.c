...
/*
 * NAME
 *	Tspi_Context_GetCapability20.c
 *
 * DESCRIPTION
 ...
 *	capability, subCap TSS_TCSCAP_PROP_HOST_PLATFORM
 *
 * ALGORITHM
 *	Setup:
 *		Create Context
...
{
	char *nameOfFunction = "Tspi_Context_GetCapability20";
	...
	subCap = TSS_TCSCAP_PROP_HOST_PLATFORM;
	...
	if (result != TSS_SUCCESS) {
		...
		/* Prints out the Host Platform Information */
		offSet = 0;
