...
int main_v1_1(void)
{
	char *nameOfFunction = "Tspi_Context_GetCapability19";
	...
	subCap = TSS_TCSCAP_PROP_MANUFACTURER_ID;
	...
	if (result != TSS_SUCCESS) {
		...
		fprintf(stderr, "Manufacturer ID is: 0x%x\n", *(UINT32 *)prgbRespData);
