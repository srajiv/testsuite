...
/*
 * NAME
 *	Tspi_Context_CloseObject02.c
 *
 * DESCRIPTION
 *	This test will verify Tspi_Context_CloseObject.
 *	The purpose of this test is to return TSS_E_INVALID_HANDLE. This is
 *		done by passing an invalid (handle) second parameter. 
 *		This test case passes in -1 for the second parameter.
 *
 * ALGORITHM
 *	Setup:
 *		Create Context
...
main_v1_1(void){
	...
	char		*nameOfFunction = "Tspi_Context_CloseObject02";
	...
	if(result != TSS_SUCCESS){
		...
		//Close Object
	result = Tspi_Context_CloseObject(hContext, -1);
