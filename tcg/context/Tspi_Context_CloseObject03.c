...
/*
 * NAME
 *	Tspi_Context_CloseObject03.c
 *
 * DESCRIPTION
 *	This test will verify Tspi_Context_CloseObject.
 *	The purpose of this test is to get TSS_E_INVALID_HANDLE 
 *		to be returned. This can be accomplished by not 
 *		creating an object to be closed. 
 *
 * ALGORITHM
 *	Setup:
 *		Create Context
...
main_v1_1(void){
	...
	char		*nameOfFunction = "Tspi_Context_CloseObject03";
	...
	if(result != TSS_SUCCESS){
		...
		//Close Object
	result = Tspi_Context_CloseObject(hContext, hSignatureKey);
