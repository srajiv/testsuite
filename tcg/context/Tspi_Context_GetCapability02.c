...
/*
 * NAME
 *	Tspi_Context_GetCapability02.c
 *
 * DESCRIPTION
 ...
 *		in an incorrect value for the capArea.
 *
 * ALGORITHM
 *	Setup:
 *		Create Context
...
main_v1_1(void){
	...
	char		*nameOfFunction	= "Tspi_Context_GetCapability02";
	TSS_HCONTEXT	hContext;
	TSS_FLAG	capArea		= (TSS_TSPCAP_VERSION+TSS_TSPCAP_ALG);
	UINT32		subCap;
