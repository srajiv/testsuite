...
main_v1_1(void){
	...
	char		*nameOfFunction	= "Tspi_Context_GetCapability06";
	...
	ulSubCapLength = sizeof(UINT32);
		...
		//Get Capability
	result = Tspi_Context_GetCapability(-1,
			capArea, ulSubCapLength, (BYTE *)&subCap,
			&checker, &prgbRespData);
