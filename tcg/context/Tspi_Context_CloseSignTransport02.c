...
/*
 * NAME
 *	Tspi_Context_CloseSignTransport02
 *
 * DESCRIPTION
...
{
	char		*nameOfFunction = "Tspi_Context_CloseSignTransport02";
...
#warning Change these calls to Tspi_TPM_GetSRKPub when it exists
	...
	/* The only transported command will be this key load */
	...
	result = Tspi_Context_CloseSignTransport(0xffffffff, hSigningKey, NULL);
