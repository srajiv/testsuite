...
/*
 * NAME
 *	Tspi_Context_CreateObject02.c
 *
 * DESCRIPTION
 *	This test will verify Tspi_Context_CreateObject.
 *	This purpose of this test case is to get TSS_E_BAD_PARAMETER to be 
 *		returned. This is accomplished by passing in an invalid second
 *		parameter. 
 *
 * ALGORITHM
 *	Setup:
