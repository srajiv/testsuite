...
/*
 * NAME
 *	Tspi_Context_LoadKeyByUUID01.c
 *
 * DESCRIPTION
 *	This test will verify Tspi_Context_LoadByUUID.
 *	The purpose of this test is to return TSS_SUCCESS. This
 *		is accomplished by following the algorithm 
 *		defined below correctly. 
 *
 * ALGORITHM
 *	Setup:
 *		Create Context
...
main_v1_1(void){
	...
	char		*nameOfFunction = "Tspi_Context_LoadKeyByUUID01";
