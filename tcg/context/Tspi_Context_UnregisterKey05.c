...
/*
 * NAME
 *	Tspi_Context_UnregisterKey05.c
 *
 * DESCRIPTION
 *	This test will verify Tspi_Context_UnregisterKey
 *	The purpose of this test case is to get TSS_E_PS_KEY_NOTFOUND
 *		to be returned. This is accomplished by unregistering
 *		the key using TSS_PS_TYPE_USER when the key is registered with
 *		TSS_PS_TYPE_SYSTEM.
 * 
 * ALGORITHM
 *	Setup:
