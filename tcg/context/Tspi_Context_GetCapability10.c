...
main_v1_1(void){
	...
	char		*nameOfFunction	= "Tspi_Context_GetCapability10";
	TSS_HCONTEXT	hContext;
	TSS_FLAG	capArea		= TSS_TCSCAP_CACHING;
	UINT32		subCap;
	...
	subCap = TSS_TCSCAP_PROP_AUTHCACHE;
