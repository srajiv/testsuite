...
/*
 * NAME
 *	Tspi_Context_GetKeyByPublicInfo03.c
 *
 * DESCRIPTION
 *	This test will verify Tspi_Context_GetKeyByPublicInfo.
 *	The purpose of this test is to get TSS_E_INVALID_HANDLE to 
 *		be returned. This easily accomplished by passing in 
 *		and invalid first parameter.
 *
 * ALGORITHM
 *	Setup:
 *		Create Context
...
main_v1_1(void){
	...
	if (result != TSS_SUCCESS) {
		...
		//GetKeyByPublicInfo
	result = Tspi_Context_GetKeyByPublicInfo(-1, 
