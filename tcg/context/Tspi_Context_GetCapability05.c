...
/*
 * NAME
 *	Tspi_Context_GetCapability05.c
 *
 * DESCRIPTION
 *	This test will verify Tspi_Context_GetCapability.
 *	The purpose of this test is pass in a -1 for ulSubCapLength, 
 *		and verify that this does not cause a segmentation fault. 
 *
 * ALGORITHM
 *	Setup:
 *		Create Context
...
main_v1_1(void){
	...
	char		*nameOfFunction	= "Tspi_Context_GetCapability05";
	TSS_HCONTEXT	hContext;
	TSS_FLAG	capArea		= TSS_TCSCAP_ALG;
	UINT32		subCap		= TSS_ALG_AES;
	UINT32		ulSubCapLength	= 0xffffffff;
	BYTE**		prgbRespData;
