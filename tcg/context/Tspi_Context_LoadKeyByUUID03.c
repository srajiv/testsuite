...
/*
 * NAME
 *	Tspi_Context_LoadKeyByUUID03.c
 *
 * DESCRIPTION
 *	This test will verify Tspi_Context_LoadByUUID.
 *	The purpose of this test is to get TSS_E_PS_KEY_NOTFOUND to be 
 *		returned. This is done by using USER not SYSTEM. 
 *
 * ALGORITHM
 *	Setup:
 *		Create Context
...
main_v1_1(void){
	...
	char		*nameOfFunction = "Tspi_Context_LoadKeyByUUID03";
