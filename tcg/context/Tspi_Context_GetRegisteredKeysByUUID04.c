...
/*
 * NAME
 *	Tspi_Context_GetRegisteredKeysByUUID04.c
 *
 * DESCRIPTION
 *	This test will verify Tspi_Context_GetRegisteredKeysByUUID.
 *	The purpose of this test case is to get TSS_E_BAD_PARAMETER 
 *		to be returned. This is accomplished by instead of 
 *		passing in TSS_PS_TYPE_SYSTEM, TSS_PS_TYPE_USER 
...
main_v1_1(void){
	...
	char		*nameOfFunction = "Tspi_Context_GetRegisteredKeysByUUID04";
