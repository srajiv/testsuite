...
/*
 * NAME
 *	Tspi_Context_UnregisterKey04.c
 *
 * DESCRIPTION
 *	This test will verify Tspi_Context_UnregisterKey
 *	The purpose of this test is to get TSS_E_PS_KEY_NOTFOUND to be returned. 
 *		This is done by not registering the key to be unregistered.
 *
 * ALGORITHM
 *	Setup:
 *		Create Context
