...
/*
 * NAME
 *	Tspi_Key_GetPubKey-trans02.c
 *
 * DESCRIPTION
 *	This test will verify that Tspi_Key_GetPubKey executes successfully inside a transport
 *	session.
 *
 * ALGORITHM
 *	Setup:
...
{
	char		*function = "Tspi_Key_GetPubKey-trans02";
