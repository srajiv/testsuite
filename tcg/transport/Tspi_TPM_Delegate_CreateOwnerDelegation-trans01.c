...
/*
 * NAME
 *	Tspi_TPM_Delegate_CreateOwnerDelegation01.c
 *
 * DESCRIPTION
 *	This test will verify that Tspi_TPM_Delegate_CreateOwnerDelegation
 *		returns TSS_SUCCESS.
 *
 * ALGORITHM
 *	Setup:
 ...
 *
 *	Test:
 *		Call TPM_Delegate_CreateOwnerDelegation.
...
{
	char *			function = "Tspi_TPM_Delegate_CreateOwnerDelegation-trans01";
