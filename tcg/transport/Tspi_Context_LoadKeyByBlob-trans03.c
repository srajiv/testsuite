...
{
	char		*function = "Tspi_Context_LoadKeyByBlob-trans03";
	TSS_HCONTEXT	hContext;
	TSS_HKEY	hSRK;
	TSS_HKEY	hMSigningKey, hWrappingKey;
	...
	result = Testsuite_Transport_Init(hContext, hSRK, hTPM, TRUE, TRUE, &hWrappingKey, NULL);
	if (result != TSS_SUCCESS) {
