...
/*
 * NAME
 *	Tspi_Key_CreateMigrationBlob-trans02.c
 *
 * DESCRIPTION
...
{
	char		*nameOfFunction = "Tspi_Key_CreateMigrationBlob-trans02";
	TSS_HCONTEXT	hContext;
	TSS_HKEY	hSRK;
	TSS_HKEY	hKeyToMigrate;
	TSS_HKEY	hMigrationAuthorityKey, hSigningKey, hWrappingKey;
	BYTE		*MigTicket;
	UINT32		TicketLength;
	BYTE		*randomData;
	UINT32		randomLength;
	...
	TSS_RESULT	result;
	TSS_HTPM	hTPM;
	TSS_HPOLICY	hPolicy, hMigPolicy, hUsagePolicy, tpmUsagePolicy;
