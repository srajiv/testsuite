...
{
	char		*nameOfFunction = "Tspi_ChangeAuth-trans03";
	TSS_HKEY	hKeyChild, hKeyParent, hSRK, hWrappingKey;
	...
	result = Testsuite_Transport_Init(hContext, hSRK, hTPM, FALSE, TRUE, &hWrappingKey, NULL);
	if (result != TSS_SUCCESS) {
