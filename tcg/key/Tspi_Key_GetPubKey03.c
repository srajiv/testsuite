...
/*
 * NAME
 *	Tspi_Key_GetPubKey03.c
 *
 * DESCRIPTION
 *	This test will return TSS_E_BAD_PARAMETER, because
 *		TSS_E_INTERNAL_ERROR is passed as the first
 *		parameter to Key_GetPubKey, rather than hKey.
 *
 * ALGORITHM
 *	Setup:
 *		Create Context
...
main_v1_1( void )
{
	char		*function = "Tspi_Key_GetPubKey03";
	...
	if ( result != TSS_SUCCESS )
	{
		...
		// Get Pub Key
	result = Tspi_Key_GetPubKey( hKey, &ulPubKeyLength,
					NULL );
