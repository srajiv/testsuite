...
/*
 * NAME
 *	Tspi_GetAttribData18.c
 *
 * DESCRIPTION
 *	This test will verify Tspi_GetAttribData.
 *	The purpose of this test is to get the popup string from a policy
 *	object and verify that it's correct.
 *
 * ALGORITHM
 *	Setup:
 *		Create Context
...
main_v1_1(void){
	char		*nameOfFunction = "Tspi_GetAttribData18";
	TSS_FLAG	initFlags;
	...
	if (result != TSS_SUCCESS) {
		...
		//Call GetAttribData
	result = Tspi_GetAttribData(hPolicy,
