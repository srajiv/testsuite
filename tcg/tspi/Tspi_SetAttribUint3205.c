...
/*
 * NAME
 *	Tspi_SetAttribUint3205.c
 *
 * DESCRIPTION
 *	This test will return TSS_E_INVALID_ATTRIB_DATA because
 *		incorrect values are passed in for various attributes.
 *
 * ALGORITHM
 *	Setup:
 *		Create Context
...
main_v1_1( void )
{
	char			*function = "Tspi_SetAttribUint3205";
	TSS_HKEY		hParentKey;
	...
	result = Tspi_SetAttribUint32( hParentKey,
					...
					-1 );
	if ( TSS_ERROR_CODE(result) != TSS_E_INVALID_ATTRIB_DATA )
	{
