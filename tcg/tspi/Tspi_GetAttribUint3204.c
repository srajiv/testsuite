...
/*
 * NAME
 *	Tspi_GetAttribUint3204.c
 *
 * DESCRIPTION
 *	This test will return TSS_E_BAD_PARAMETER, because:
 *		- a hash object is called with an rsa key flag and subflag.
 *		- the address to return the value to is NULL
 *
 * ALGORITHM
 *	Setup:
 *		Create Context
...
main_v1_1( void )
{
	char			*function = "Tspi_GetAttribUint3204";
	TSS_HKEY		hParentKey;
