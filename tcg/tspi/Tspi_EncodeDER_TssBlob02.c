...
{
	char		*function = "Tspi_EncodeDER_TssBlob02";
	...
	if ( result != TSS_SUCCESS )
	{
		...
		// EncodeDER_TssBlob (pass in a zero length blob)
	ulEncBlobLength = 0;
	rgbEncBlob = NULL;
	result = Tspi_EncodeDER_TssBlob( 0, rgbBlob, TSS_BLOB_TYPE_KEY, &ulEncBlobLength, rgbEncBlob );
