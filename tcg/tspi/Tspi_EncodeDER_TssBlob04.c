...
{
	char		*function = "Tspi_EncodeDER_TssBlob04";
	...
	if ( result != TSS_SUCCESS )
	{
		...
		// EncodeDER_TssBlob (pass in an invalid blob type - below lowest value)
	ulEncBlobLength = 0;
	rgbEncBlob = NULL;
	result = Tspi_EncodeDER_TssBlob( ulBlobLength, rgbBlob, 0, &ulEncBlobLength, rgbEncBlob );
