...
/*
 * NAME
 *	Tspi_SetAttribData06.c
 *
 * DESCRIPTION
 *	This test will verify Tspi_SetAttribData.
 *	The purpose of this test case is to get TSS_E_BAD_PARAMETER 
 *		to be returned. Instead of passing in strlen(POPUPSTRING) 
 *		this test case passes in an invalid parameter of -1.
 *
 * ALGORITHM
 *	Setup:
 *		Create Context
...
main_v1_1(void){
	...
	char		*nameOfFunction = "Tspi_SetAttribData06";
	TSS_HKEY	hKey;
