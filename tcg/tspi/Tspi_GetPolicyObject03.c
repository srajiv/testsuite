...
/*
 * NAME
 *	Tspi_GetPolicyObject03.c
 *
 * DESCRIPTION
 *	This test will return TSS_E_BAD_PARAMETER, because
 *		TSS_KEY_SIZE_1024 is passed as the second
 *		parameter to GetPolicyObject, rather than
 *		TSS_POLICY_USAGE, for objects hSRK and hEncData.
 *
 * ALGORITHM
 *	Setup:
 *		Create Context
 ...
 *
 *	Test:
 *		Call GetPolicyObject twice then if it does not succeed
 *		Make sure that it returns the proper return codes
 *		Print results
 *
 *	Cleanup:
 *		Free memory related to hSRK
 *		Close context
 *
 * USAGE
