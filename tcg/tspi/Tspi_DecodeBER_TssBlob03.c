...
{
	char		*function = "Tspi_DecodeBER_TssBlob03";
	...
	if ( result != TSS_SUCCESS )
	{
		...
		// DecodeBER_TssBlob (pass in a NULL blob pointer)
	ulDecBlobLength = 0;
	rgbDecBlob = NULL;
	result = Tspi_DecodeBER_TssBlob( ulEncBlobLength, NULL, &ulBlobType, &ulDecBlobLength, rgbDecBlob );
