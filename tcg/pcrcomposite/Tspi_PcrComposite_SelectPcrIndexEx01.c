...
/*
 * NAME
 *	Tspi_PcrComposite_SelectPcrIndexEx01.c
 *
 * DESCRIPTION
...
{
	char		*function = "Tspi_PcrComposite_SelectPcrIndexEx01";
	...
	if ( result != TSS_SUCCESS )
	{
		...
		// select pcr index
	result = Tspi_PcrComposite_SelectPcrIndexEx( hPcrComposite, 8, TSS_PCRS_DIRECTION_RELEASE );
	if ( result != TSS_SUCCESS )
	{
