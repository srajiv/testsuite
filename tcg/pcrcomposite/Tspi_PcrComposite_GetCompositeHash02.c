...
/*
 * NAME
 *	Tspi_PcrComposite_GetCompositeHash02.c
 *
 * DESCRIPTION
...
{
	char		*function = "Tspi_PcrComposite_GetCompositeHash02";
	...
	result = Tspi_PcrComposite_GetCompositeHash(0xffffffff, &pLen, &ppbHashData );
