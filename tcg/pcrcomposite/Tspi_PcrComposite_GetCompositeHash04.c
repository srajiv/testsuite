...
/*
 * NAME
 *	Tspi_PcrComposite_GetCompositeHash04.c
 *
 * DESCRIPTION
 *	This test will verify that Tspi_PcrComposite_GetCompositeHash
 *		returns TSS_E_BAD_PARAMETER when its passed one.
 *
 * ALGORITHM
 *	Setup:
 *		Create Context
...
{
	char		*function = "Tspi_PcrComposite_GetCompositeHash04";
	...
	result = Tspi_PcrComposite_GetCompositeHash(hPcrComposite, NULL, &ppbHashData );
