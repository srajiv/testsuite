...
/*
 * NAME
 *	Tspi_PcrComposite_GetCompositeHash05.c
 *
 * DESCRIPTION
...
{
	char		*function = "Tspi_PcrComposite_GetCompositeHash05";
	...
	result = Tspi_PcrComposite_GetCompositeHash(hPcrComposite, &pLen, NULL );
