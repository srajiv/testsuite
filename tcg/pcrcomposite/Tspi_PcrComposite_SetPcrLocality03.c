...
/*
 * NAME
 *	Tspi_PcrComposite_SetPcrLocality03.c
 *
 * DESCRIPTION
 *	This test will verify that Tspi_PcrComposite_SetPcrLocality
 *		returns TSS_E_INVALID_OBJ_ACCESS when used on a 1.1 PCRs object.
 *
 * ALGORITHM
 *	Setup:
 *		Create Context
...
{
	char		*function = "Tspi_PcrComposite_SetPcrLocality03";
	...
	result = Tspi_PcrComposite_SetPcrLocality( hPcrComposite, TPM_LOC_THREE );
