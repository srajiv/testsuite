...
/*
 * NAME
 *	Tspi_PcrComposite_GetPcrValue02.c
 *
 * DESCRIPTION
 *	This test will return TSS_E_INVALID_HANDLE,
 *		because whPcrComposite = -1 is passed in as the
 *		first parameter in PcrComposite_GetPcrValue,
 *		instead of hPcrComposite.
 *
 * ALGORITHM
 *	Setup:
 *		Create Context
...
main_v1_1( void )
{
	char		*function = "Tspi_PcrComposite_GetPcrValue02";
	...
	if ( result != TSS_SUCCESS )
	{
		...
		// get pcr value
	result = Tspi_PcrComposite_GetPcrValue( whPcrComposite, 8,
						&ulPcrValueLength,
						&prgbPcrValueOut );
