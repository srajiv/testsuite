 ...
 *		in an incorrect first parameter.  Instead of 
 *		passing in the correct handle, hContext, in 
 *		for the first parameter, -1 is passed in instead. 
 *
 * ALGORITHM
 *	Setup:
 *		Create Context
