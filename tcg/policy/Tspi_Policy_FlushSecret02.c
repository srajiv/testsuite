...
/*
 * NAME
 *	Tspi_Policy_FlushSecret02.c
 *
 * DESCRIPTION
 *	This test returns TSS_E_INVALID_HANDLE due to
 *		whPolicy=-1 being passed to Policy_FlushSecret,
 *		rather than hPolicy.
 *
 * ALGORITHM
 *	Setup:
 ...
 *
 *	Test:
 *		Call Tspi_Policy_FlushSecret then if it does not succeed
